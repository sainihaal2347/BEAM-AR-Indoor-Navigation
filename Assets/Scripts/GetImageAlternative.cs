...
public class GetImageAlternative : MonoBehaviour
{
    ...
    private void Update()
    {
        if (arCameraBackground == null || targetRenderTexture == null || qrCodeText == null) 
        {
        ...
        cameraImageTexture.ReadPixels(new Rect(0, 0, targetRenderTexture.width, targetRenderTexture.height), 0, 0);
